...
for ((i=0; i < ITERS; i++))
do
./build/release/Tinyconst -n 128 -c sha-256 -e 400, 1, 1 -ip $1
sleep 2
done
...
for ((i=0; i < ITERS; i++))
do
./build/release/Tinyconst -n 256 -c sha-256 -e 400,1,1 -ip $1
sleep 2
done
...
for ((i=0; i < ITERS; i++))
do
./build/release/Tinyconst -n 256 -c sha-256 -e 400,256,256 -ip $1
sleep 2
done