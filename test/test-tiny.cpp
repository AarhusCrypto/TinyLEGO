...
TEST(Protocol, SHA_1) {
  num_iters = 2;
  Params params_const(num_iters * 37500, num_iters * 512, num_iters * 160, 1);
  Params params_eval(num_iters * 37500, num_iters * 512, num_iters * 160, 1);
...
TEST(Protocol, SHA_256) {
  num_iters = 2;
  Params params_const(num_iters * 236700, num_iters * 512, num_iters * 256, 2);
  Params params_eval(num_iters * 236700, num_iters * 512, num_iters * 256, 2);
